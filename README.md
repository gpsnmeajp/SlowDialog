...
- **カスタマイズ可能なテーマ** — 複数のレトロ風カラーテーマとスキャンライン効果を選べます。
...
ツールバーのエクスポートボタンから、会話履歴をJSON形式でダウンロードできます。エクスポートされたJSONにはクイックレスポンス設定、システムプロンプト、会話履歴が含まれます。
